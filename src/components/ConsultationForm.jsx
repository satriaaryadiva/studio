...
export default function ConsultationForm() {
  ...
  return (
    <section id="consultation" className="relative bg-theme py-24 md:py-36 overflow-hidden border-t border-theme-md">
      ...
      <div className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-[#9E8976]/[0.06] blur-[120px] rounded-full pointer-events-none" />
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative lg:col-span-7 bg-theme-surface p-8 md:p-12 rounded-[2rem] border border-theme-md shadow-sm"
          >
            {sent ? (
